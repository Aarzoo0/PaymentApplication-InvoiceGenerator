...
public class PaymentController {
    ...
    // 7. Endpoint to find TDS final amount
    @GetMapping("/tds-final-amount/{invoiceNumber}")
    public ResponseEntity<Double> getAmountTdsFinalAmount(@PathVariable String invoiceNumber) {
        return new ResponseEntity<>(paymentService.getAmountTdsFinalAmount(invoiceNumber), HttpStatus.OK);
    }
